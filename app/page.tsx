      ...
      <section id="certification" className="px-6 py-8 lg:py-16 lg:px-8">
        <div className="mx-auto max-w-screen-2xl">
          ...
          >
            ...
            <p className={`mt-5 text-sm leading-7 text-neutral-600 ${lato.className}`}>
              I am a registered drone pilot with the {pilotCertification.issuer}.
              You&apos;re in safe hands—every flight is carried out by someone who
              has completed official CAA training and holds a valid Flyer ID.
            </p>
